...
## Руководитель курса Python для аналитики

***OTUS** (Февраль 2022 — по настоящее время)* 

Разработка курса
Обновление курса при моторном запуске
Преподавание
Работа с командой курса
